...
document.querySelector(".block1 .uagb-buttons-repeater.wp-block-button__link").onclick = function(){
    ...
    let prodacts = [    
        ...
        document.querySelector(".wp-block-woocommerce-all-products.wc-block-all-products > div.wc-block-grid.has-4-columns.has-multiple-rows > ul > li:nth-child(14) > div.wp-block-button.wc-block-components-product-button.wc-block-grid__product-add-to-cart > button"),
